...
const Navbar = () => {
  ...
  return (
    ...
    ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all dark:bg-slate-600 dark:text-white ease-in-out" : ""}`
      }>
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <a className="md:text-2xl font-bold cursor-pointer">BOOK-O-MANIA</a>
          </div>
